...
document.addEventListener("DOMContentLoaded", () => {
  ...
  class AccessForm {
    ...
    // checks password and confirm password inputs according to the rules
    ...
    //handles the form itself by letting submit button active/deactive
  ...
  // handles submit event for signup form
  ...
  // handles submit event for loginform
